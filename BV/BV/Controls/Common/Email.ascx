<%@ Control Language="C#" AutoEventWireup="true" Inherits="Controls_Common_Email" Codebehind="Email.ascx.cs" %>

<asp:UpdatePanel runat="server" ID="EmailUpdatePanel" UpdateMode="Conditional">
    <Triggers>
    ...
    <asp:Panel ID="EmailPanel" runat="server" CssClass="email inlinepopup" Visible="false">
            <asp:LinkButton ID="EmailHeaderPanel" runat="server" OnClick="EmailButtonCancel_Click" CssClass="closebox right">
